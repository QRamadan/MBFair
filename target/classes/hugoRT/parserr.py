...
class Parser:
    ...
    def protected_characteristics(self):
        ...
        '''
        return self.find(".//protectedData")
    ...
    def generate_initializations(self):
        ...
        print("Guard conditions containing class attributes")
        print("-----Conditions for attributes--------")
        pprint(guard_conditions_with_attributes_and_class)
        print("-----End Conditions for attributes--------")
        print("-----Conditions for derived attributes--------")
        pprint(guard_conditions_with_derived_attributes_and_class)
        print("-----End Conditions for derived attributes--------")

        print("---------End Gaurd Conditions-------------")
        ...
        with open('initializations_table.csv', 'w') as f:
            # using csv.writer method from CSV package
            write = csv.writer(f)
            write.writerows(table)

        # Getting and saving protected characteristics
        try:
            protected_characteristics = self.protected_characteristics().text
        except:
        ...
        for character in disallowed_characters:
            try:
                protected_characteristics = protected_characteristics.replace(character, "")
            except:
                continue
        try:
            protected_characteristics = list(protected_characteristics.split(","))
            print("protected_characteristics",protected_characteristics)
        except:
            protected_characteristics = None

        packagedElement = self.find_all(".//packagedElement")
        prepended_protected_characteristics = []
        try:
            for i in packagedElement:
                attributes = self.get_all_attibutes(i)
                for j in attributes:
                    if j.get("name") in protected_characteristics:
                        prepended_protected_characteristics.append(i.get("name") + '_' + j.get("name"))
        except:
            print("")

        with open('protected_characteristics.csv', 'w') as f:
            # using csv.writer method from CSV package
            write = csv.writer(f)
        ...
        pprint(data_types)
        with open('attributes_data_types.csv', 'w') as f:
            # using csv.writer method from CSV package
            write = csv.writer(f)
        ...
        try:
            decision_data_attributes = self.get_decision_data_attributes()
        except Exception:
            print("The noise in this class is ineradicable the ineptitdue fo the class to keep")
        
        with open('statistics.csv', 'w', newline='') as f:
            # using csv.writer method from CSV package
            write = csv.writer(f)
            write.writerow([ "Elements", len(self.find_all(".//")) ])
            write.writerow([ "Annotated_Elements", "2" ])
            write.writerow([ "Data_Attributes", len(self.find_all(".//ownedAttribute")) ])
            write.writerow([ "Decision_Data_Attributes", " ".join(decision_data_attributes)])
            write.writerow([ "Protected_Characteristics", " ".join(prepended_protected_characteristics) ])
            write.writerow([ "Proxy_Information", "0" ])
    ...
    def get_decision_data_attributes(self):
        ...
        try:
            ...
            print(decision_data_attribs,"decision_data_attribs")
            ...
            with open('decision_data_attribs.csv', 'w') as f:
                # using csv.writer method from CSV package
                write = csv.writer(f)
                write.writerow(prepended_decision_data_attribs)

            with open('decision_data_attribs_types.csv', 'w') as f:
                # using csv.writer method from CSV package
                write = csv.writer(f)
