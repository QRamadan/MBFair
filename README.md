...
* **Algorithms: the algorithms of generating temporal logic claims and checking individual-fairness:** https://github.com/confFair/project/blob/master/algorithms.pdf
